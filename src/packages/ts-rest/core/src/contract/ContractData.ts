...
export interface GenericContractData<T extends AnyObject> {
  query?: T | undefined;
  params?: T | undefined;
  headers?: T | undefined;
  body?: T | undefined;
...
export type AnyContractData = GenericContractData<AnyObject>;
export type UnknownContractData = GenericContractData<UnknownObject>;
