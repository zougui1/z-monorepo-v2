export const theme = {
  ...
  'editor.token.keyword': '#56b6c2',
  'editor.token.dialogue': '#98c379',
  'editor.token.thought': '#e5c07b',
  'editor.token.label': '#61afef',
  'editor.token.link': '#c678dd',
  'editor.token.heading': '#e06c75',
  'editor.token.list': '#e5c07b',
  'editor.token.italic': '#c678dd',
  'editor.token.bold': '#d19a66',
};
