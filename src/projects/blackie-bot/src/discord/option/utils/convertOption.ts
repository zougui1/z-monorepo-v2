...
const convertMap: Record<string, (option: Option<any, any>, schema: z.Schema) => Exclude<ApplicationCommandOptionData, ApplicationCommandSubGroupData | ApplicationCommandSubCommandData>> = {
...
export const convertOption = (option: Option<any, any>, schema: z.ZodType): Exclude<ApplicationCommandOptionData, ApplicationCommandSubGroupData | ApplicationCommandSubCommandData> => {
