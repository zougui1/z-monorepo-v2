...
export const LocationDialog = ({ location, onSubmit, onClose }: LocationDialogProps) => {
  ...
  return (
    <GameDataDialog.Root open={Boolean(location)} onOpenChange={onClose}>
      <GameDataDialog.Form {...form} ref={formRef} onSubmit={handleSubmit}>
        <GameDataDialog.Title>Location</GameDataDialog.Title>
        ...
        <GameDataDialog.Body>
          ...
          <GameDataDialog.Table
            title="Villagers"
            data={villagers}
            columns={villagerColumns}
          />
        </GameDataDialog.Body>

        <GameDataDialog.Footer onSave={handleSaveChanges} />
      </GameDataDialog.Form>
    </GameDataDialog.Root>
  );
}
...
export const BuildingDialog = ({ building, onSubmit, onClose }: BuildingDialogProps) => {
  ...
  return (
    <GameDataDialog.Root open={Boolean(building)} onOpenChange={onClose}>
      <GameDataDialog.Form {...form} ref={formRef} onSubmit={handleSubmit}>
        <GameDataDialog.Title>Building</GameDataDialog.Title>
